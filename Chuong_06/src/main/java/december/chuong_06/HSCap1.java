 ...
 * @author AN515-45
 */
public class HSCap1 extends HocSinh{
    private double diemVan;
    private double diemToan;

    public HSCap1(double diemVan, double diemToan, String maHS, String tenHS, String phai) {
    ...
    public String xepLoai() {
        return this.tinhTB() >=5 ? "Dat" : "Khong Dat"; //To change body of generated methods, choose Tools | Templates.
    }
