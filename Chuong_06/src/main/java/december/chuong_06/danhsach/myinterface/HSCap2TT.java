 ...
 * @author AN515-45
 */
public class HSCap2TT extends HocSinhTT implements I_HocSinh{
    private double diemVan;
    private double diemToan;
    private double diemLy;
    private double diemHoa;

    public HSCap2TT(String maHS, String tenHS, String phai, double diemVan, double diemToan, double diemLy, double diemHoa) {
